...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 20.570343871977027; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -712.317889104513; // x position of the perpendicular encoder (in tick units)
    }
