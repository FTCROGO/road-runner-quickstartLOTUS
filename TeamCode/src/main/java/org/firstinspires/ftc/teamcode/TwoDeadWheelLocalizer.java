...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 309.9070632637818; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1103.3829801207587; // x position of the perpendicular encoder (in tick units)
    }
...
// Sarah needs to double-check the upstream is correct (and not the original below)
